...
PMF_FILE = "output/free_energy.abf1.czar.pmf"                  # The input PMF file containing free energy data
CONTOUR_LEVELS = [1.2, 4, 7]                                   # Contour levels corresponding to free energy values
CONTOUR_COLOR_RANGE = [1, 10]                                  # Color range for contour levels
CONTOUR_OPACITIES = [0.9, 0.4, 0.3]                            # Opacity for each contour level
